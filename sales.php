...
echo "</div>";
if(is_array($grandtotalarray) ) { 

$total = array_sum($grandtotalarray); } else { 
$total = 0; } 
if(is_array($grandpayarray) ) { 
$payments = array_sum($grandpayalarray); } else { 
$payments = 0; } 
if(is_array($grandtaxalarray) ) { 
$tax = array_sum($grandstaxalarray); } else { 
$tax = 0; } 
